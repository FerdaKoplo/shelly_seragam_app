<x-shared.modal_base name="global-delete-modal" maxWidth="md" :showCloseButton="false">
    <div x-data="{ url: '', message: 'Apakah Anda yakin?' }" 
        ...
        <h2 class="font-roboto text-black mb-8 px-2 leading-snug text-xl" x-text="message"></h2>

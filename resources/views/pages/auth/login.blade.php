...
@section('content')
    <div class="text-black h-screen flex items-center justify-between pl-36 overflow-hidden">
        ...
        <form action="{{ route('login') }}" method="POST" class="bg-brand h-full w-[40%] border-r-primary border-r-[1.2rem] border-l-[1.2rem] border-l-black flex flex-col items-center justify-center px-10">
            @csrf

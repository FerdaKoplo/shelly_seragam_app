...
@section('content')
<div class="flex justify-start mt-6 px-10 pb-20" data-cy="kustom-page">
    <div class="w-full flex flex-col gap-6">
        ...
        <div class=" flex items-center gap-3 flex-wrap"
            ...
            <div class="border border-black  py-3 rounded-2xl px-4 gap-4 flex pr-12" >
                ...
                <button data-cy="section-tab-{{ Str::slug($sec) }}"
                    type="button" @click="active = '{{ $sec }}'" :class="active === '{{ $sec }}'
            ...
            <div class="w-full flex flex-col gap-3 mt-2">
                ...
                <div 
                data-cy="kustom-item"
                x-show="active === '{{ $kustom->spesifikasi_khusus }}'"

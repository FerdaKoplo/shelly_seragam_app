...
<div class="px-12 pb-20">
    <div class="flex mt-6 gap-16 ">
        <div class="flex flex-col gap-5 w-full">
            ...
            <div class="grid grid-cols-1 w-full  gap-6 ">
                ...
                <div
                    data-cy="stat-card-{{ Str::slug($stat['title']) }}" class="{{ $stat['bg'] }} rounded-xl p-5 text-white shadow-md flex items-center gap-4 transition hover:scale-105">
        ...
        <div class="flex flex-col w-full">
            ...
            <div class="flex items-end font-inter justify-end mt-7">
                <h1 data-cy="total-revenue" class="text-3xl">
    ...
    <div class="flex items-end justify-between gap-8">
        <div class="flex flex-col gap-4">
            ...
            <div>
                <table data-cy="transactions-table" class="w-full text-left border-collapse">
                    <thead>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr  data-cy="transaction-row" class="hover:bg-gray-50 transition">
                            ...
                            <td data-cy="product-type" class="px-6 py-4 text-sm text-gray-600">
                                {{ $jenisProduk }}
                            </td>
                        ...
                        @empty
                        <tr>
                            <td data-cy="empty-transactions" colspan="5" class="px-6 py-10 text-center text-gray-500 font-medium">
            ...
            <div data-cy="transactions-pagination">
                {{ $allTransactions->onEachSide(1)->links('vendor.pagination.custom')  }}
            </div>
        </div>

        <a   data-cy="export-spreadsheet-btn" href="{{ route('statistik.transaksi.export', ['bulan' => request('bulan')]) }}"

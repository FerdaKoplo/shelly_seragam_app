                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="relative">
                        <textarea name="deskripsi" rows="5" placeholder="Tambahkan Deskripsi Syarat & Ketentuan"
                            data-cy="voucher-description-input"
            ...
            <div class="lg:col-span-5 space-y-6 md:space-y-10">
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="relative">
                            <input data-cy="voucher-name-input" type="text" name="nama_voucher"
                                value="{{ old('nama_voucher') }}" placeholder="Contoh: Promo Akhir Tahun"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="relative">
                            <input type="text" data-cy="voucher-code-input" name="kode_voucher"
                                value="{{ old('kode_voucher') }}" placeholder="KODE-CUSTOM"

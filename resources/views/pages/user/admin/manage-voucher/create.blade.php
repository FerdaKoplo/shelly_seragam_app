...
<x-shared.notification />
    <div class="px-6 pb-12">
        ...
        <form action="{{ route('manage.voucher.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-28">
            @csrf
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="relative">
                        <select name="jenis_voucher" class="w-full border border-black rounded-md px-4 py-3 focus:outline-none focus:ring-1 focus:ring-black appearance-none" required>
                            ...
                            <option value="nominal" {{ old('jenis_voucher') == 'nominal' ? 'selected' : '' }}>Nominal (Rp)</option>
                            <option value="persentase" {{ old('jenis_voucher') == 'persentase' ? 'selected' : '' }}>Persentase (%)</option>
                        </select>
            ...
            <div class="lg:col-span-5 space-y-10">
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="relative">
                            <input type="text" name="nama_voucher" value="{{ old('nama_voucher') }}" placeholder="Contoh: Promo Akhir Tahun"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="relative">
                            <input type="text" name="kode_voucher" value="{{ old('kode_voucher') }}" placeholder="KODE-CUSTOM"
                    ...
                    <div class="flex flex-col gap-2 mt-2">
                        ...
                        <div class="relative">
                            <input type="number" name="nilai_diskon" value="{{ old('nilai_diskon') }}" placeholder="0"

...
<div class="px-32 justify-center items-center my-6 max-w-full overflow-y-auto flex-grow">
    ...
    <div class="fixed bottom-[10%] right-[2%] z-50">
            ...
            <x-shared.button data-cy="btn-whatsapp" variant="outline" class="w-full md:w-auto py-4 px-4" href="https://wa.me/6287893385014?text=Halo%20Shelly%20Seragam%2C%20saya%20ingin%20konsultasi.">

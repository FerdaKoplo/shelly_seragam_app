<section class="relative bg-secondary min-h-[500px] lg:h-[600px] flex items-center overflow-hidden">
    {{-- Decorative Background Circle --}}
    <div class="absolute bottom-5 left-1/2 bg-black rounded-full opacity-45" style="width: 20rem; height: 20rem;"></div>
    
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-8 py-12 items-center">
        {{-- Left Content --}}
        <div class="flex flex-col justify-center z-10">
            <h1 class="text-[100px] md:text-[180px] font-black uppercase leading-[0.8] tracking-[-0.05em] text-black">
                SHELLY
            </h1>
            <h2 class="text-[42px] md:text-[76px] font-medium uppercase tracking-[0.35em] mt-2 text-black leading-none">
                SERAGAM
            </h2>

            <div class="mt-12 space-y-2 text-xl">
        ...
        <div class="relative h-[450px] md:h-[550px] flex items-center justify-end"
            x-data="{ 
        active: 0, 
        images: [
        ...
        init() {
            ...
            <template x-for="(img, index) in images" :key="index">
                ...
                <div
                    class="absolute w-3/4 h-[95%] transition-all duration-700 ease-in-out cursor-pointer"
                    @click="next()"
